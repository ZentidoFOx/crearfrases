...
return [
    ...
    'protected' => [
        ...
        ['GET', '/api/v1/users/wordpress-credentials/:websiteId', [UserController::class, 'getWordPressCredentials']],
        ['POST', '/api/v1/users/wordpress-credentials/:websiteId', [UserController::class, 'saveWordPressCredentials']],
        ['POST', '/api/v1/users/wordpress-credentials/:websiteId/test', [UserController::class, 'testWordPressConnection']],
